      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300">A platform for sharing your thoughts and ideas with the world.</p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 text-center">
          <p className="text-gray-300">&copy; {new Date().getFullYear()} BlogApp. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
